...
public:
    ...
    bool CreateTransaction(const std::vector<std::pair<CScript, int64> >& vecSend, int type,
    ...
    std::string SendMoneyToDestination(const CTxDestination &address, int type, int64 nValue, CWalletTx& wtxNew, bool fAskFee=false);
