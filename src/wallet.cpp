...
string CWallet::SendMoney(CScript scriptPubKey, int type, int64 nValue, CWalletTx& wtxNew, bool fAskFee)
{
    ...
    string strError;
    if (!CreateTransaction(scriptPubKey, type, nValue, wtxNew, reservekey, nFeeRequired, strError))
    {
