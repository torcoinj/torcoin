...
public:
    CMainParams() {
        ...
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << CBigNum(0) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        ...
        assert(hashGenesisBlock == uint256("0x0000002b289779842f67ae3974d366c41520bbf9001549374a0d123b16277de8"));
        assert(genesis.hashMerkleRoot == uint256("0x44492e8cbf7acd45168c265225bd445d3fdd27edf50076d5ce37d68248054052"));
